    ...
    <div class="flex justify-center items-center bg-gray-50">
        <div class="w-4/5 flex flex-col items-center">
            ...
            <section class="bg-gray-100 py-12 px-6 rounded-2xl shadow-md mt-12">
                <div class="flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div class="w-full md:w-2/3 lg:w-3/5">
                        <span class="inline-block bg-yellow-800 text-white text-l font-semibold px-5 py-2 rounded-full mb-4">
                            About us
                        </span>
            ...
            <section class="mx-auto py-12">
                <h2 class="inline-block bg-yellow-800 text-white text-lg font-semibold px-6 py-3 rounded-full mb-8 shadow-md">
                    Program aktif
                </h2>
                    ...
                    @foreach ($program_3 as $berita )
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col">
                            ...
                            <div class="p-4 flex flex-col flex-grow">
                                ...
                                <a href="{{ url('sd/program/'.$berita->id) }}"

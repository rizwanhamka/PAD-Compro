            ...
            @if ($program->link)
                <div class="text-center mt-16">
                    <a href="{{ $program->link }}" target="_blank"
                       class="inline-block bg-purple-700 hover:bg-purple-800 text-white text-lg font-semibold px-10 py-4 rounded-xl shadow-lg transition duration-300 transform hover:-translate-y-1 hover:shadow-xl">
